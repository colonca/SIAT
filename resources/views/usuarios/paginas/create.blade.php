        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="" style="color: white;">
                    <i class="material-icons">perm_identity</i>Nueva Pagina
                </a>
            </li>
        </ol>
    </div>
            ...
            <div class="body table-responsive">
                <form action="{{route('paginas.store')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input name ="nombre" type="text" class="form-control" placeholder="Ingresa el nombre de la pagina">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input name ="descripcion" type="text" class="form-control" placeholder="Ingresa el nombre de la pagina">
                        </div>
                    </div>
