...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <div class="body">
            ...
            <a href="{{route('reportes_Generales')}}"<button type="button" class="btn bg-red btn-lg waves-effect">
                <span>Reportes Generales</span><i class="material-icons">poll</i>
            </button></a>
            <a href="{{route('reporte_Diagnostico')}}"<button type="button" class="btn bg-blue btn-lg waves-effect">
