...
@section('content')
    ...
    <div class="box-header with-border" style="background-color: rgb(23, 128, 62)">
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('docentes_permanencia.index')}}" style="color: white;">
                    <i class="material-icons">perm_identity</i> Gestion de Docentes de Permanencia
                </a>
            </li>
            <li>
                <a href="" style="color: white;">
                    <i class="material-icons">perm_identity</i>Nuevo Docente
                </a>
            </li>
        </ol>
    </div>
    ...
    <form id="formulario" action="docentes_permanencia">
...
@section('scripts')
    ...
    <script>
        ...
        function guardar(event) {
            ...
            axios.post('{{url('/docentes_permanencia')}}',data)
